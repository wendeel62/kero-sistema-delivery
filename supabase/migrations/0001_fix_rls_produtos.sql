...
-- 2. Drop policies antigas da tabela categorias
...
-- 3. Drop policies antigas da tabela precos_tamanho
...
-- 4. Criar nova função app.current_tenant_id() mais flexível
...
-- 5. Criar novas policies para produtos
...
-- 6. Criar policies para categorias
...
-- 7. Criar policies para precos_tamanho
...
-- 8. Backfill: garantir que todos user_roles tenham tenant_id
