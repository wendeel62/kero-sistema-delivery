...
# SQL to create missing tables and columns
$sql = @"
-- Add whatsapp columns to configuracoes if not exist
...
Write-Host "=== CRIANDO TABELAS E COLUNAS ===" -ForegroundColor Cyan
...
if ($response.status -eq "success") {
    ...
    Write-Host "Erro: $($response | ConvertTo-Json)" -ForegroundColor Red
}